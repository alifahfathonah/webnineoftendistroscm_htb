...
echo "<div class='wrapper'>
	...
	echo "</ul>
	<p class='footer'>Copyright &copy;".date('Y').". All Rights reserved.<br/>Powered by <b style='color:salmon'><a href='http://www.shareoffice.id'>Sharelink Foundations</a></b></p>
</div>";